...
from machinator.core import WORKSPACE_SENTINEL, app_paths, find_workspace_root, load_json
from machinator.ui import QUESTIONARY


def register(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    doctor_parser = subparsers.add_parser("doctor", help="Check the Machinator install and workspace health")
...
def cmd_doctor(args: argparse.Namespace) -> int:
    ...
    if workspace_root is None:
        ...
        for required_dir in (
            workspace_root / ".machinator" / "pipelines",
            workspace_root / ".machinator" / "assets",
