...
from machinator.modeling_compile import compile_architecture_spec
from machinator.modeling_specs import load_architecture_spec, validate_spec_file, write_edited_architecture_spec
from machinator.modeling_weights import diff_spec_files, migrate_checkpoint
from machinator.ui import can_prompt_interactively, prompt_text


def register(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    model_parser = subparsers.add_parser("model", help="Validate, edit, diff, compile, and migrate Machinator model specs")
